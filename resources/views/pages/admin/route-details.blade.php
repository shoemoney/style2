...
@section('breadcrumbs')
	...
	<li class="active" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
		<a itemprop="item" href="{{url('/routes')}}" disabled>
			<span itemprop="name">
				Routes List
			</span>
		</a>
					...
					<thead>
				  	...
				  	<tbody>
						@foreach ($routes as $route)
							<tr>
								<td class="mdl-data-table__cell--non-numeric"><a href="{{url('/users')}}">{{ $route->uri }}</a></td>
								<td class="mdl-data-table__cell--non-numeric"><a href="{{url('/users')}}">{{ $route->getName() }}</a></td>
								<td class="mdl-data-table__cell--non-numeric"><a href="{{url('/users')}}">{{ $route->getPrefix() }}</a></td>
								<td class="mdl-data-table__cell--non-numeric"><a href="{{url('/users')}}">{{ $route->getActionMethod() }}</a></td>
							</tr>
						@endforeach
				  	</tbody>
				</table>
