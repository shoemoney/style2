            ...
            <div class="mdl-card__actions">
                <div class="mdl-grid full-grid">
                    <div class="mdl-cell mdl-cell--12-col">
                        ...
                        <a href="{{url('/profile/' . Auth::user()->name .'/edit')}}" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-shadow--3dp mdl-button--raised mdl-button--primary mdl-color-text--white">
